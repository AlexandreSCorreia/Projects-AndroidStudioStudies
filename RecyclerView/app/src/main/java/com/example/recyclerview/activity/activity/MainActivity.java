...
public class MainActivity extends AppCompatActivity {
    ...
    public void criaFilmes(){
        ...
        Filme filme =new Filme("Joker"," Ação, Crime, Dram","2019");
        filmesL.add(filme);

        filme =new Filme("Maleficent: \nMistress of Evil","Aventura, Família, Fantasia","2019");
        filmesL.add(filme);


        filme =new Filme("It: Chapter Two","Terror","2019");
        filmesL.add(filme);

        filme =new Filme("Avengers: Endgame"," Ação, Aventura, Ficção científica","2019");
        filmesL.add(filme);

        filme =new Filme("Fast & Furious Presents: \nHobbs & Shaw"," Ação","2019");
        filmesL.add(filme);

        filme =new Filme("John Wick: Chapter 3 \n– Parabellum","Ação, Crime","2019");
        filmesL.add(filme);

        filme =new Filme("Gemini Man"," Ação","2019");
        filmesL.add(filme);

        filme =new Filme("Project X","Comédia","2012");
        filmesL.add(filme);

        filme =new Filme("Shazam!","Ação, Aventura, Comédia, Fantasia, Ficção científica","2019");
        filmesL.add(filme);

        filme =new Filme("After"," Drama, Eróticos, Romance","2019");
        filmesL.add(filme);

        filme =new Filme("Casal Improvável","Comédia, Romance", "2019");
        filmesL.add(filme);

        filme =new Filme("Homem-Aranha: \nLonge de Casa"," Ação, Aventura, Ficção científica","2019");
        filmesL.add(filme);
    }
}
