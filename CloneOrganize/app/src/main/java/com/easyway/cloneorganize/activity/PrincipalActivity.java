...
public class PrincipalActivity extends AppCompatActivity {
        ...
        valueEventListenerMovimentacoes = movimentacaoRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dados: dataSnapshot.getChildren()){
                    //Vamos está recuperando uma movimentacao inteira usando o getValue
    ...
    //Metodo para tratar as açoes do menu
    @Override
    ...
    public void configuraCalendarView(){
        ...
        //2 diz que eu quero no maximo 2 digitos e o d de digito é numero
    ...
    //é chamado sempre quando iniciar o app
    @Override
    protected void onStart() {
        super.onStart();
        recuperarResumo();
        //Fica aqui pois só vai recuperar as movimentacoes apos o calendario for configurado
        //E tambem porque terá um value event listener que tambem será removido paos sair do app
        recuperarMovimentacoes();
    }

    //Sobrescrever o metodo onStop ele é chamado quando o app não estiver mais sendo usado
    @Override
    protected void onStop() {
        super.onStop();
        //Remover o evento listener para que o fire base não fique atualizando os dados quando o usuario
        //Não estiver ultilizando o app
